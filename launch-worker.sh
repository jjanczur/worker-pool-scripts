...
WORKER_DOCKER_IMAGE_VERSION=7.0.1
#IEXEC_CORE_HOST=18.185.47.13 #NFT wallet pool
...
IEXEC_WORKER_SSL_TRUSTSTORE_PASSWORD=YaD&@g4U&!bFfiH3yNtz # This is a variable used localy. It can be public so change it!
